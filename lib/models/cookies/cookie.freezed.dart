...
mixin _$Cookie {
  ...
  CookieEnum get difficulty => throw _privateConstructorUsedError;
...
abstract class $CookieCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, double stars, CookieEnum difficulty});
}
...
class _$CookieImpl implements _Cookie {
  _$CookieImpl(
      {required this.name, required this.stars, required this.difficulty});
  ...
  final double stars;
  @override
  final CookieEnum difficulty;

  @override
  String toString() {
    return 'Cookie(name: $name, stars: $stars, difficulty: $difficulty)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, name, stars, difficulty);
...
abstract class _Cookie implements Cookie {
  factory _Cookie(
      ...
      required final CookieEnum difficulty}) = _$CookieImpl;
